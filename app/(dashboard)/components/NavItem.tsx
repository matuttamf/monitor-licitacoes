      ...
      <div className="relative">
        <button
          onClick={() => {
            ...
            timerRef.current = setTimeout(() => setTooltip(false), 3000)
          }}
        ...
        {tooltip && (
          ...
          >
            <div style={{ color: 'var(--dourado)', fontWeight: 700, fontSize: '12px', marginBottom: '4px' }}>
              🔒 Módulo bloqueado
            </div>
            <div style={{ color: 'rgba(255,255,255,0.65)', fontSize: '12px', lineHeight: 1.4, marginBottom: '10px' }}>
