      ...
      <section className="px-6 md:px-[60px] py-[70px] md:py-20 bg-[#FAF6F0]">
        <div className="max-w-[760px] mx-auto">
          ...
          {[
            ...
            ['Posso cancelar se não for o que esperava?', 'Sim, sem burocracia. No plano mensal, o cancelamento encerra a renovação imediatamente. No plano anual, o cancelamento encerra a renovação automática e o acesso permanece ativo até o fim do período já pago — sem reembolso proporcional do valor anual, conforme nossa política de preço diferenciado.'],
