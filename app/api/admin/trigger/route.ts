...
export async function POST(request: Request) {
  ...
  const rotas: Record<string, string> = {
    ...
    'alertar-urgente':                 `${baseUrl}/api/cron/alertar-urgente`,
    'onboarding-followup':             `${baseUrl}/api/cron/onboarding-followup`,
    'email-segunda':                   `${baseUrl}/api/cron/email-segunda`,
    'sync-assinaturas':                `${baseUrl}/api/cron/sync-assinaturas`,
    'coletar-resultados':              `${baseUrl}/api/cron/coletar-resultados`,
    'coletar-resultados-transparencia':`${baseUrl}/api/cron/coletar-resultados-transparencia`,
    'aviso-renovacao-anual':           `${baseUrl}/api/cron/aviso-renovacao-anual`,
    'emails-pos-assinatura':           `${baseUrl}/api/cron/emails-pos-assinatura`,
    'emails-feedback':                 `${baseUrl}/api/cron/emails-feedback`,
    'reverter-descontos':              `${baseUrl}/api/cron/reverter-descontos`,
    'indicacoes-liberar':              `${baseUrl}/api/cron/indicacoes-liberar`,
    'indicacoes-aplicar-creditos':     `${baseUrl}/api/cron/indicacoes-aplicar-creditos`,
    'indicacoes-elegibilidade':        `${baseUrl}/api/cron/indicacoes-elegibilidade`,
    'backup-db':                       `${baseUrl}/api/cron/backup-db`,
    'limpar-alertas':                  `${baseUrl}/api/cron/limpar-alertas`,
  }
