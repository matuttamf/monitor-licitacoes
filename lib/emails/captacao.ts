...
const E1: Record<Setor, E1Template> = {
  construcao: {
    ...
    p3: 'Não é crítica — é uma questão real. Prefeituras, estados e órgãos federais publicam mais de 3.200 contratos de construção por mês no Brasil, em portais diferentes, com prazo médio de 15 dias corridos. Quem monitora chega com tempo de elaborar proposta. Quem não monitora descobre quando o prazo já fechou — ou não descobre.',
    ctaText: '→ ver editais de obra do meu estado',
  ...
  limpeza: {
    ...
    p3: 'Órgãos públicos licitam limpeza o ano inteiro. São mais de 4.800 contratos por mês no Brasil, a maioria com duração de 12 a 36 meses. Quem monitora chega primeiro. Quem não monitora descobre quando o contrato já foi — às vezes meses depois.',
    ctaText: '→ ver editais de limpeza do meu estado',
  ...
  ti: {
    ...
    p3: 'O setor público brasileiro compra mais de R$ 40 bilhões em tecnologia por ano. São mais de 6.000 pregões de TI por mês, com prazo de 5 a 15 dias úteis. Quem monitora fica sabendo quando o edital é publicado. Quem não monitora só fica sabendo quando o prazo já começou a correr — se é que fica.',
    ctaText: '→ ver pregões de TI do meu segmento',
  ...
  vigilancia: {
    ...
    p3: 'O governo contrata vigilância o ano inteiro. Mais de 900 contratos por mês, a maioria com duração de 12 a 36 meses. Quem monitora recebe o alerta antes do processo abrir para propostas. Quem não monitora descobre quando já foi — ou não descobre.',
    ctaText: '→ ver editais de vigilância do meu estado',
  ...
  saude: {
    ...
    p3: 'O governo é o maior comprador de produtos de saúde do país — mais de R$ 60 bilhões por ano. São mais de 2.100 licitações por mês, algumas emergenciais com prazo de 24 horas. Quem monitora em tempo real consegue participar inclusive das emergenciais. Quem não monitora nem sabe que elas existiram.',
    ctaText: '→ ver licitações de saúde do meu segmento',
  ...
  transporte: {
    ...
    p3: 'O governo contrata transporte o ano inteiro. Mais de 1.200 contratos por mês, a maioria com duração de 12 a 36 meses e pagamento garantido. Quem monitora chega com tempo de analisar rota e calcular proposta. Quem não monitora descobre quando o prazo fechou.',
    ctaText: '→ ver editais de transporte do meu estado',
  ...
  alimentacao: {
    ...
    p3: 'Prefeituras licitam alimentação escolar o ano inteiro. São mais de 2.400 contratos por mês no Brasil, a maioria com duração de 12 meses e renovação anual. Quem monitora chega a tempo de calcular logística e precificar proposta. Quem não monitora descobre depois que o contrato já foi para outro fornecedor.',
    ctaText: '→ ver editais de alimentação da minha região',
  ...
  generico: {
    ...
    p3: 'O governo federal publicou mais de R$ 240 bilhões em contratos nos últimos 12 meses só no PNCP. Estados e municípios somam volume equivalente. A maioria das empresas fornecedoras participa de uma fração mínima dos editais compatíveis — não por falta de capacidade, mas porque os editais fecham antes de chegarem ao radar.',
...
const E2: Record<Setor, E2Template> = {
  construcao: {
    assunto: '{{NOME}}, tem uma construtora no seu estado monitorando agora',
  ...
  limpeza: {
    assunto: '{{NOME}}, empresa de limpeza da sua região recebeu 14 alertas esta semana',
  ...
  ti: {
    assunto: '{{NOME}}, software house da sua cidade monitora pregões em tempo real',
  ...
  vigilancia: {
    assunto: '{{NOME}}, empresa de vigilância do seu estado monitora editais agora',
  ...
  saude: {
    assunto: '{{NOME}}, fornecedora do setor de saúde monitora licitações em tempo real',
  ...
  transporte: {
    assunto: '{{NOME}}, transportadora da sua região monitora contratos em tempo real',
  ...
  alimentacao: {
    assunto: '{{NOME}}, fornecedora de alimentos da sua região monitora editais agora',
  ...
  generico: {
    assunto: '{{NOME}}, um concorrente do seu setor monitora editais em tempo real',
...
const E3: Record<Setor, E3Template> = {
  construcao: {
    assunto: '{{NOME}}, de 3 obras para 19 em um ano — o que mudou',
  ...
  limpeza: {
    assunto: '{{NOME}}, de 2 contratos para 9 em 6 meses — o que mudou',
  ...
  ti: {
    assunto: '{{NOME}}, de 0% para 38% da receita em contratos públicos — em 11 meses',
  ...
  vigilancia: {
    assunto: '{{NOME}}, de 3 contratos para 11 em um ano — o que mudou',
  ...
  saude: {
    assunto: '{{NOME}}, de fornecedora regional para contrato federal — em 8 meses',
  ...
  transporte: {
    assunto: '{{NOME}}, de 2 contratos para 8 em um ano — o que mudou',
  ...
  alimentacao: {
    assunto: '{{NOME}}, de 1 para 9 prefeituras em 8 meses — o que mudou',
  ...
  generico: {
    assunto: '{{NOME}}, o que muda quando uma empresa começa a monitorar licitações',
...
const E5: Record<Setor, E5Template> = {
  construcao: {
    assunto: '{{NOME}}, empresa elétrica do Paraná: 2 contratos em 2 meses',
  ...
  limpeza: {
    assunto: '{{NOME}}, empresa de limpeza hospitalar: 4 contratos novos em 4 meses',
  ...
  ti: {
    assunto: '{{NOME}}, empresa de suporte no Nordeste: R$ 290k no primeiro pregão federal',
  ...
  vigilancia: {
    assunto: '{{NOME}}, empresa de vigilância no Nordeste: primeiro contrato federal em 15 anos',
  ...
  saude: {
    assunto: '{{NOME}}, distribuidora de insumos hospitalares: R$ 2,1M em novos contratos',
  ...
  transporte: {
    assunto: '{{NOME}}, transportadora do Centro-Oeste: 3 contratos federais em 5 meses',
  ...
  alimentacao: {
    assunto: '{{NOME}}, fornecedora de merenda no Norte: de 1 para 12 prefeituras',
  ...
  generico: {
    assunto: '{{NOME}}, empresa de serviços: primeiro contrato público em 8 anos de operação',
...
const E4 = {
  assunto: '{{NOME}}, três razões que travam — e minha resposta para cada uma',
...
const E6 = {
  assunto: '{{NOME}}, contratos que fecharam este mês sem você participar',
...
const E7 = {
  assunto: '{{NOME}}, uma pergunta direta',
