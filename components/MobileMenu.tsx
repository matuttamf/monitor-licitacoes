...
export function MobileMenu() {
  ...
  return (
    <div className="md:hidden">
      ...
      {/* Portal: escapa do stacking context criado pelo backdrop-filter do header */}
      {mounted && open && createPortal(
        <>
          ...
          {/* Painel lateral */}
          <div
            className="fixed top-0 right-0 bg-white shadow-2xl flex flex-col overflow-y-auto"
            style={{ zIndex: 9999, width: '280px', height: '100vh' }}
          >
            {/* Cabeçalho */}
            <div className="flex items-center justify-between px-5 border-b border-[#F0EDE8] shrink-0" style={{ height: '64px' }}>
